...
nnoremap <silent><space>W :wall<CR>
nnoremap <silent><space>Q :qall<CR>

nnoremap <silent><space>es <cmd>!npx eslint --fix '%:p'<CR>
...
nmap <silent> <space>dvo :DV<CR>
nmap <silent> <space>dvhc :DHC<CR>
nmap <silent> <space>dvc :DVC<CR>
nmap <silent> <space>dvh :DVH<CR>
nmap <silent> <space>dvm :DVM<CR>
nmap <silent> <space>dvd :DVD<CR>
...
command DHC :DiffviewFileHistory %
command DVC :DiffviewClose
command DVH :DiffviewFileHistory
